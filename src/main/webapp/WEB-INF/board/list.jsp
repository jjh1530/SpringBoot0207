...
<script>
	...
	function printBoard(vo) {
		...
		regForm.find("#idx").val(vo.idx);  // remove 하기 위해  idx 값도 넣어줌
	  ...
	  <div class="card">
	    <div class="card-header">
			<div class="jumbotron jumbotron-fluid">
			  <div class="container">
			    <h1>SpringBoot WEB MVC</h1>
			    <p>SpringBoot WEB TEST</p>
			  </div>
			</div>
		</div>
	    <div class="card-body">
							  ...
							  <tbody>
							  	<c:forEach var="vo" items="${list }">
							  	  <tr>
							  	  	...
							  	  	<td><fmt:formatDate pattern="yyyy-MM" value="${vo.indate }"/></td>
							  	  </tr>
							  	</c:forEach>
							  </tbody>
							</table>
